...
def generate_one(
    ...
    for _ in range(nombre_jobs):
        ...
        release_date        = random.randint(0, max(0, min(due_date_max // 3, due_date - min_treat_time)))
...
# TEST WITH: python instance_generator_with_costs.py --train=150 --test=50 --path=./
if __name__ == "__main__":
    ...
    base_path: str = args.path + "data/instances_cost/"
